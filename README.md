# GPMF Introduction
DISCLAIMER: forked from https://github.com/gopro/gpmf-parser so that I can put my own parser tools in a repository. Full credit to the authors for this great set of tools.
